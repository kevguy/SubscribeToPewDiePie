...
The primary difference between the row space and the column space, is in the way that you ask the question of whether a given vector is in the row space of the matrix. That changes how you multiply the matrix by the vector, and it changes the way that the coefficients are interpreted.
